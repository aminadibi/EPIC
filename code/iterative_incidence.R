...
#source('C:/Users/maadibi/Dropbox/UBC/CORE/Epic/code/WIP/code/core.R')
#init_session()
...
#sink("iterationoutput-desktop.txt")
...
for (i in 1:nIterations){
 ...
 # if (i>1){
  ...
  #} 
  #else {
   #latest_COPD_inc_logit <- input$COPD$ln_h_COPD_betas_by_sex 
  #}
...
#  latest_COPD_inc_logit[1,1] <- -6;
 # latest_COPD_inc_logit [1,2] <- -6.2;
